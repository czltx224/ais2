 ...
 */
@Entity
@Table(name = "BAS_CQ_ST_CORPORATE_RATE")
@Rate(mapping="代理标准协议价")
public class BasCqStCorporateRate implements java.io.Serializable,
		AuditableEntity {
	...
	/** default constructor */
	public BasCqStCorporateRate() {
	}

	// Property accessors
	@Id
	@SequenceGenerator(name = "generator", sequenceName = "SEQ_CQ_ST_CORPORATE_RATE ")
