 ...
 */
@Entity
@Table(name = "OPR_HISTORY")
public class OprHistory implements java.io.Serializable {
	...
	/** minimal constructor */
	public OprHistory(Long id) {
		this.id = id;
	}

	/** full constructor */
	public OprHistory(Long id, String oprName, Long oprNode, String oprComment,
	...
	@SequenceGenerator(name = "generator", sequenceName = "SEQ_OPR_HISTORY ")
