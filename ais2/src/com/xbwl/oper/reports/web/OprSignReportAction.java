...
/**
 * author CaoZhili
 * time Nov 24, 2011 5:32:25 PM
 * 签收时效报表控制层操作类
 */
@Controller
@Action("oprSignReportAction")
@Scope("prototype")
@Namespace("/reports")
@Results( {
		@Result(name = "input", location = "/WEB-INF/xbwl/reports/query/opr_signReport.jsp", type = "dispatcher"),
...
public class OprSignReportAction  extends SimpleActionSupport{
	...
	public String findList(){
		...
		String sql ="";
		try{
			sql = this.oprEnterPortReportService.findSignListService(map);
