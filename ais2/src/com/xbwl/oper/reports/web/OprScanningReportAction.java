...
/**扫描时效报表控制层操作类
 * author CaoZhili
 * time Nov 25, 2011 10:43:50 AM
 */
@Controller
@Action("oprScanningReportAction")
@Scope("prototype")
@Namespace("/reports")
@Results( {
		@Result(name = "input", location = "/WEB-INF/xbwl/reports/query/opr_scanningReport.jsp", type = "dispatcher"),
...
public class OprScanningReportAction extends SimpleActionSupport{
	...
	public String findList(){
		...
		String sql ="";
		try{
			sql = this.oprEnterPortReportService.findScanningListService(map);
