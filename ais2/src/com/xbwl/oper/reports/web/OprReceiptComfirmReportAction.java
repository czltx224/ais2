...
/**
 * author CaoZhili
 * time Nov 25, 2011 9:11:28 AM
 * 回单确收时效报表控制层操作类
 */
@Controller
@Action("oprReceiptComfirmReportAction")
@Scope("prototype")
@Namespace("/reports")
@Results( {
		@Result(name = "input", location = "/WEB-INF/xbwl/reports/query/opr_receiptComfirmReport.jsp", type = "dispatcher"),
...
public class OprReceiptComfirmReportAction extends SimpleActionSupport {
	...
	public String findList(){
		...
		String sql ="";
		try{
			sql = this.oprEnterPortReportService.findReceiptComfirmListService(map);
