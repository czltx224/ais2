 ...
 * 
 * $Id: SimpleHibernateDao.java,v 1.6 2011/03/13 03:23:51 yyj Exp $
 */
...
public class SimpleHibernateDao<T, PK extends Serializable> {
	 ...
	 * 执行SQL进行批量修改/删除操作.
	 */
	public int batchSQLExecute(final String hql, final Object... values) {
		return this.createSQLQuery(hql, values).executeUpdate();
	}
