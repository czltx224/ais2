 ...
 * 
 * $Id: Page.java,v 1.3 2010/07/29 09:55:48 yyj Exp $
 */
...
public class Page<T> {
	...
	protected List<Map> resultMap = Lists.newArrayList();
	
	protected Object  totalObject = new Object();
	...
	public void setOrder(final String order) {
		...
		for (String orderStr : orders) {
			if (!StringUtils.equals(DESC, orderStr) && !StringUtils.equals(ASC, orderStr)) {
				// REVIEW 方法需要声明抛出异常，该异常将可能引起未知的后果，
	...
	public void setTotalObject(Object totalObject) {
