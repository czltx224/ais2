 ...
 * @createTime 11:30:17 AM
 * @updateName Administrator
 * @updateTime 11:30:17 AM
 * 
 */
//REVIEW 该类是否还有效？有的话需要写明作用
public class SvnServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		super.init();
		System.out.println("**** Starting SvnServlet ......");
		
		appctx = WebApplicationContextUtils.getRequiredWebApplicationContext(getServletContext());
		((ISysVersionsMsgService)appctx.getBean("sysVersionsMsgService")).inserMsg();
	}
