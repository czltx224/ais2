//专车标准协议价js
var privilege=93;//权限参数
var gridSearchUrl="fi/basStSpecialTrainRateAction!ralaList.action";//查询地址
var saveUrl="fi/basStSpecialTrainRateAction!save.action";//保存地址
var delUrl="fi/basStSpecialTrainRateAction!deleteStatus.action";//删除地址
var auditUrl="fi/basStSpecialTrainRateAction!auditStatus.action";//审核地址
var dictionaryUrl='sys/dictionaryAction!ralaList.action';//数据字典地址
var searchCusNameUrl='stock/oprStoreAreaAction!list.action';//查询代理公司地址
