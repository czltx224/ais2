//签收时效标准设置js
var privilege=200;//权限参数
var gridSearchUrl="reports/oprSignLimitationAction!list.action";//查询地址
var saveUrl="reports/oprSignLimitationAction!save.action";//保存地址
var delUrl="reports/oprSignLimitationAction!delete.action";//删除地址
var departUrl='sys/departAction!findDepart.action';//业务部门查询地址
var dictionaryUrl='sys/dictionaryAction!ralaList.action';//数据字典地址
var rowWidth=70;
var  fields=['id','operationType','remark',
			'signStandardDay','signStartTime','countStartTime','signEndTime',
	...
	var tbar=[{text:'<b>导出</b>',iconCls:'sort_down',handler:function() {
        ...
        } },'-',{text:'<b>新增</b>',iconCls:'userAdd',id:'basenterPortAdd',tooltip : '新增签收标准',handler:function() {
                	saveenterPort(null);
            } },'-',
	 	{text:'<b>修改</b>',iconCls:'userEdit',id:'basenterPortEdit',disabled:true,tooltip : '修改签收标准',handler:function(){
		...
		var _records = enterPort.getSelectionModel().getSelections();
	 	...
	 	{text:'<b>删除</b>',iconCls:'userDelete',id:'basenterPortDelete',disabled:true,tooltip : '删除签收标准',handler:function(){
	 		var enterPort =Ext.getCmp('enterPortCenter');
			var _records = enterPort.getSelectionModel().getSelections();
	...
	{xtype:'textfield',blankText:'查询数据',id:'searchContent', enableKeyEvents:true,listeners : {
	 	...
	 	'-',{ 
    					...
    					store : [['', '查询全部'],
    							...
    							['EQS_countRange','计算频率'],
    							['EQL_signStandardDay','出库日期差'],
    						    ['EQS_signStartTime', '开始时间'],
    						    ['EQS_signEndTime', '结束时间'],
    						    ['EQS_countStartTime', '标准时间']],
    ...
    enterPortGrid = new Ext.grid.GridPanel({
        ...
        cm:new Ext.grid.ColumnModel([rowNum,sm,
        		...
        		{header: '操作方式', dataIndex: 'operationType',width:rowWidth,sortable : true},
       			{header: '签收时效标准', dataIndex: 'countStartTime',width:rowWidth,sortable : true},
       			{header: '配车出库时间', dataIndex: 'signStartTime',width:rowWidth,sortable : true},
       			{header: '签收录入时间', dataIndex: 'signEndTime',width:rowWidth,sortable : true},
       			{header: '出库日期差', dataIndex: 'signStandardDay',width:rowWidth,sortable : true},
...
function saveenterPort(_records) {
											...
											items : [{
														...
														items : [{
																...
																},
																{
																	...
																	forceSelection : true,
																	minChars : 0,
																	fieldLabel : '签收标准时效<font style="color:red;">*</font>',
																	name : 'countStartTime',
																	maxLength:5,
																	allowBlank : false,
																	anchor : '95%'
														...
														items : [{
																	...
																	forceSelection : true,
																	minChars : 0,
																	fieldLabel : '配车出库时间<font style="color:red;">*</font>',
																	name : 'signStartTime',
																	maxLength:5,
																	allowBlank : false,
																	anchor : '95%'
																	...
																	forceSelection : true,
																	minChars : 0,
																	fieldLabel : '签收录入时间<font style="color:red;">*</font>',
																	name : 'signEndTime',
																	maxLength:5,
																	allowBlank : false,
																	anchor : '95%'
																	...
																	xtype : 'numberfield',
																	labelAlign : 'left',
																	fieldLabel : '出库日期差<font style="color:red;">*</font>',
																	allowBlank : false,
																	allowNegative :false,
																	maxLength:10,
																	name : 'signStandardDay',
																	anchor : '95%'
																},{
																	xtype:'textarea',
																	fieldLabel : '备注',
		...
		enterPortTitle='添加签收标准信息';
		if(cid!=null){
		enterPortTitle='修改签收标准信息';
		//departStore.load();
