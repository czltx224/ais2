//扫描时效标准设置js
var privilege=201;//权限参数
var gridSearchUrl="reports/oprScanningLimitationAction!list.action";//查询地址
var saveUrl="reports/oprScanningLimitationAction!save.action";//保存地址
var delUrl="reports/oprScanningLimitationAction!delete.action";//删除地址
var departUrl='sys/departAction!findDepart.action';//业务部门查询地址
var dictionaryUrl='sys/dictionaryAction!ralaList.action';//数据字典地址
var rowWidth=70;
var  fields=['id','operationType','remark','scanStandardTime',
			'scanStandardDay','scanStartTime','scanEndTime',
	...
	var tbar=[{text:'<b>导出</b>',iconCls:'sort_down',handler:function() {
        ...
        } },'-',{text:'<b>新增</b>',iconCls:'userAdd',id:'basenterPortAdd',tooltip : '新增扫描标准',handler:function() {
                	saveenterPort(null);
            } },'-',
	 	{text:'<b>修改</b>',iconCls:'userEdit',id:'basenterPortEdit',disabled:true,tooltip : '修改扫描标准',handler:function(){
		...
		var _records = enterPort.getSelectionModel().getSelections();
	 	...
	 	{text:'<b>删除</b>',iconCls:'userDelete',id:'basenterPortDelete',disabled:true,tooltip : '删除扫描标准',handler:function(){
	 		var enterPort =Ext.getCmp('enterPortCenter');
			var _records = enterPort.getSelectionModel().getSelections();
	...
	{xtype:'textfield',blankText:'查询数据',id:'searchContent', enableKeyEvents:true,listeners : {
	 	...
	 	'-',{ 
    					...
    					store : [['', '查询全部'],
    							...
    							['EQS_countRange','计算频率'],
    							['EQL_scanStartDays','开始天数'],
    							['EQL_scanEndDays', '结束天数'],
    						    ['EQL_scanStandardDays', '标准天数'],
    						    ['EQS_scanStartTime', '开始时间'],
    						    ['EQS_scanEndTime', '结束时间'],
    						    ['EQS_scanStandardTime', '标准时间']],
   ...
   var sm = new Ext.grid.CheckboxSelectionModel({});
    ...
    enterPortGrid = new Ext.grid.GridPanel({
        ...
        cm:new Ext.grid.ColumnModel([rowNum,sm,
        		...
        		{header: '扫描开始时间', dataIndex: 'scanStartTime',width:rowWidth,sortable : true},
 				{header: '扫描结束时间', dataIndex: 'scanEndTime',width:rowWidth,sortable : true},
 				{header: '扫描标准时间', dataIndex: 'scanStandardTime',width:rowWidth,sortable : true},
 				{header: '扫描标准天数', dataIndex: 'scanStandardDay',width:rowWidth,sortable : true},
...
function saveenterPort(_records) {
											...
											items : [{
														...
														items : [{
																...
																},
																{
																	...
																	forceSelection : true,
																	minChars : 0,
																	fieldLabel : '扫描标准时间<font style="color:red;">*</font>',
																	name : 'scanStandardTime',
																	maxLength:5,
																	allowBlank : false,
																	anchor : '95%'
																},{
																	xtype : 'numberfield',
																	labelAlign : 'left',
																	fieldLabel : '扫描标准天数<font style="color:red;">*</font>',
																	allowBlank : false,
																	allowNegative :false,
																	maxLength:10,
																	name : 'scanStandardDay',
																	anchor : '95%'
																},{
																	xtype : "combo",
																	editable:false,
														...
														items : [{
																	...
																	forceSelection : true,
																	minChars : 0,
																	fieldLabel : '扫描开始时间<font style="color:red;">*</font>',
																	name : 'scanStartTime',
																	maxLength:5,
																	allowBlank : false,
																	anchor : '95%'
																	...
																	forceSelection : true,
																	minChars : 0,
																	fieldLabel : '扫描结束时间<font style="color:red;">*</font>',
																	name : 'scanEndTime',
																	maxLength:5,
																	allowBlank : false,
																	anchor : '95%'
		...
		enterPortTitle='添加扫描标准信息';
		if(cid!=null){
		enterPortTitle='修改扫描标准信息';
		//departStore.load();
