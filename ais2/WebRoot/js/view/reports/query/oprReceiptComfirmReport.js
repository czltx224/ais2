//回单确收时效报表查询显示js
var searchReportUrl='reports/oprReceiptComfirmReportAction!findList.action';//时效报表查询地址
...
var fields=['ID','COUNTDATE','DNO','WEBSITE','OPERATIONTYPE','OUTTIMEPOINT','SIGNTIME','COMFIRMTIME',
			'COMFIRMSTANDARDTIME','COMFIRMISSTANDARD','DEFERHOUR','DEPTID','DEPTNAME','REAL_GO_WHERE','OUT_TIME'];
	...
	var tbar=[
		...
		'开始:',startone,' 至 ',endone,'-',{text : '<b>统计</b>',id : 'btn',iconCls : 'btnSearch',
	 	...
	 	var twoBar = new Ext.Toolbar([ '确收是否达标:',{
	 			xtype : "combo",
				width : defaultWidth,
				editable:true,
				triggerAction : 'all',
...
Ext.onReady(function() {
   ...
   var sm = new Ext.grid.CheckboxSelectionModel({});
    ...
    enterPortReportGrid = new Ext.grid.GridPanel({
       ...
       cm:new Ext.grid.ColumnModel([rowNum,sm,
            ...
            {header:'出库时间',dataIndex:"OUT_TIME",width:colWidth,sortable:true},
			...
			{header:'网点名称',dataIndex:'WEBSITE',width:colWidth,sortable:true},
			{header:'配车出库时间截点',dataIndex:'OUTTIMEPOINT',width:colWidth,sortable:true},
			{header:'签收时间',dataIndex:'SIGNTIME',width:colWidth,sortable:true},
			{header:'回单确收时间',dataIndex:'COMFIRMTIME',width:colWidth,sortable:true},
			{header:'回单确收标准时间',dataIndex:'COMFIRMSTANDARDTIME',width:colWidth,sortable:true},
			{header:'回单确是否达标',dataIndex:'COMFIRMISSTANDARD',width:colWidth,sortable:true
 ...
 function searchSenterPortReport() {
	...
	var comfirmIsStandard = Ext.getCmp('comfirmIsStandard').getRawValue();
	...
	var searchOperationType = Ext.get('searchOperationType').dom.value;
 	 Ext.apply(dateStore.baseParams, {
 	 	...
 	 	filter_comfirmIsStandard:comfirmIsStandard,
 	 	filter_dno:searchDno,
 	 	filter_deptId:pubauthorityDepart,
 	 	filter_outTimePoint:searchOutCarTime,
