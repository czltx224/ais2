//回单确收时效标准设置js
var privilege=203;//权限参数
var gridSearchUrl="reports/oprReceiptComfirmLimitationAction!list.action";//查询地址
var saveUrl="reports/oprReceiptComfirmLimitationAction!save.action";//保存地址
var delUrl="reports/oprReceiptComfirmLimitationAction!delete.action";//删除地址
var departUrl='sys/departAction!findDepart.action';//业务部门查询地址
var dictionaryUrl='sys/dictionaryAction!ralaList.action';//数据字典地址
var rowWidth=70;
var  fields=['id','operationType','remark','comfirmStandardTime',
			'comfirmStandardDay','comfirmStartTime','comfirmEndTime',
	...
	var tbar=[{text:'<b>导出</b>',iconCls:'sort_down',handler:function() {
        ...
        } },'-',{text:'<b>新增</b>',iconCls:'userAdd',id:'basenterPortAdd',tooltip : '新增回单确收标准',handler:function() {
                	saveenterPort(null);
            } },'-',
	 	{text:'<b>修改</b>',iconCls:'userEdit',id:'basenterPortEdit',disabled:true,tooltip : '修改回单确收标准',handler:function(){
		...
		var _records = enterPort.getSelectionModel().getSelections();
	 	...
	 	{text:'<b>删除</b>',iconCls:'userDelete',id:'basenterPortDelete',disabled:true,tooltip : '删除回单确收标准',handler:function(){
	 		var enterPort =Ext.getCmp('enterPortCenter');
			var _records = enterPort.getSelectionModel().getSelections();
	...
	{xtype:'textfield',blankText:'查询数据',id:'searchContent', enableKeyEvents:true,listeners : {
	 	...
	 	'-',{ 
    					...
    					store : [['', '查询全部'],
    							...
    							['EQS_countRange','计算频率'],
    							['EQL_comfirmStartDays','开始天数'],
    							['EQL_comfirmEndDays', '结束天数'],
    						    ['EQL_comfirmStandardDays', '标准天数'],
    						    ['EQS_comfirmStartTime', '开始时间'],
    						    ['EQS_comfirmEndTime', '结束时间'],
    						    ['EQS_comfirmStandardTime', '标准时间']],
   ...
   var sm = new Ext.grid.CheckboxSelectionModel({});
    ...
    enterPortGrid = new Ext.grid.GridPanel({
        ...
        cm:new Ext.grid.ColumnModel([rowNum,sm,
        		...
        		{header: '操作方式', dataIndex: 'operationType',width:rowWidth,sortable : true},
        		{header: '回单确收开始时间', dataIndex: 'comfirmStartTime',width:rowWidth,sortable : true},
 				{header: '回单确收结束时间', dataIndex: 'comfirmEndTime',width:rowWidth,sortable : true},
 				{header: '回单确收标准时间', dataIndex: 'comfirmStandardTime',width:rowWidth,sortable : true},
 				{header: '回单确收标准天数', dataIndex: 'comfirmStandardDay',width:rowWidth,sortable : true},
 				...
 				{header: '备注', dataIndex: 'remark',width:rowWidth,sortable : true}
        ]),
        store:dateStore,
        tbar: tbar,
  	    listeners: {
...
function saveenterPort(_records) {
											...
											items : [{
														...
														items : [{
																...
																},
																{
																	...
																	forceSelection : true,
																	minChars : 0,
																	fieldLabel : '确收标准时间<font style="color:red;">*</font>',
																	name : 'comfirmStandardTime',
																	maxLength:5,
																	allowBlank : false,
																	anchor : '95%'
																},{
																	xtype : 'numberfield',
																	labelAlign : 'left',
																	fieldLabel : '确收标准天数<font style="color:red;">*</font>',
																	allowBlank : false,
																	allowNegative :false,
																	maxLength:10,
																	name : 'comfirmStandardDay',
																	anchor : '95%'
																},{
																	xtype : "combo",
																	editable:false,
														...
														items : [{
																	...
																	forceSelection : true,
																	minChars : 0,
																	fieldLabel : '确收开始时间<font style="color:red;">*</font>',
																	name : 'comfirmStartTime',
																	maxLength:5,
																	allowBlank : false,
																	anchor : '95%'
																},{
																	...
																	forceSelection : true,
																	minChars : 0,
																	fieldLabel : '确收结束时间<font style="color:red;">*</font>',
																	name : 'comfirmEndTime',
																	maxLength:5,
																	allowBlank : false,
																	anchor : '95%'
		...
		enterPortTitle='添加回单确收标准信息';
		if(cid!=null){
		enterPortTitle='修改回单确收标准信息';
		//departStore.load();
